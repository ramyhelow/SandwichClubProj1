...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        akaTV = findViewById(R.id.aka_textView);
        placeOfOriginTV = findViewById(R.id.placeOfOrigin_textView);
        descriptionTV = findViewById(R.id.description_textView);
        ingredientsTV = findViewById(R.id.ingredients_textView);
    ...
    private void populateUI() {
        ...
        akaTV.setText(akaStringBuilder.toString());
